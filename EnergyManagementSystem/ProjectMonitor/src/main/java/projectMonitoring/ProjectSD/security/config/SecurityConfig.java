package projectMonitoring.ProjectSD.security.config;
...
import projectMonitoring.ProjectSD.exception.AccessDeniedHandlerBean;
import projectMonitoring.ProjectSD.security.filter.AuthorizationFilter;
    ...
    public SecurityFilterChain filterChain(
        ...
        return http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        .requestMatchers(JwtUtil.AUTH_PATHS_TO_SKIP).permitAll()
